"""REGEXLAB core — Test, explain & benchmark regexes + a library of security patterns."""
...
RULES = [
    ("REG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("REG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("REG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
