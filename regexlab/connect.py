"""Native cognis-connect emit for regexlab — forward findings to any platform.

Maps regexlab's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    regexlab ... --format json | regexlab-emit --to stix
    regexlab-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
