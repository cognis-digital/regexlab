#!/usr/bin/env sh
# Universal installer for regexlab. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/regexlab.git"
echo "Installing regexlab ..."
