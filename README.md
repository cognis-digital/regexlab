...
[![PyPI](https://img.shields.io/pypi/v/cognis-regexlab.svg)](https://pypi.org/project/cognis-regexlab/)
[![CI](https://github.com/cognis-digital/regexlab/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/regexlab/actions)
...
REGEXLAB exists for one job — test, explain & benchmark regexes + a library of security patterns — and does it without a SaaS bill or heavyweight setup.
...
```bash
regexlab --version
regexlab scan .                      # scan the current project
regexlab scan . --format json
regexlab scan . --fail-on high       # non-zero exit for CI gates
regexlab mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **regex101**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`regexlab` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
